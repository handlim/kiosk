...
{
    public class ClassForEnvironment64
    {
        [DebuggerNonUserCode]
        public ClassForEnvironment64()
        {
        }

        [DllImport("CyStat64.dll", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "CvSetColorDataVersion", CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int CvSetColorDataVersion_(int lPortNum, int lpBuff, int bLen);

        [DllImport("CyStat64.dll", EntryPoint = "SetColorDataWrite", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetFirmwDataWrite", CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int CvSetFirmwDataWrite_(int lPortNum, int lpBuff, int bLen);

        [DllImport("CyStat64.dll", EntryPoint = "CvSetCommand", CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int CvSetCommand_(int lPortNum, int lpCmd, int dwCmdLen);

        [DllImport("CyStat64.dll", EntryPoint = "CvGetCommand", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "CvGetCommandEX", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetColorDataVersion", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetCommand", CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int SetCommand_(int lPortNum, int lpCmd, int dwCmdLen);

        [DllImport("CyStat64.dll", EntryPoint = "GetCommand", CharSet = CharSet.Ansi, SetLastError = true)]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "GetCommandEX", CharSet = CharSet.Ansi, SetLastError = true)]
